		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td colspan="2" class="text-center">
					<span style="font-size: 25px; font-weight: bold;">Sistema PUNTO DE VENTA</span>
				</td>
			</tr>
			<tr>
				<td width="10%" style="vertical-align: top; padding-top: 10px; position: relative">
					<img src="{{ asset('assets/img/logo.png') }}" alt="" class="invoice-logo">
				</td>
