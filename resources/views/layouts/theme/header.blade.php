    ...
    <header class="header navbar navbar-expand-sm">
        <ul class="navbar-item flex-row">
            <li class="nav-item theme-logo">
                <a href="{{route('dash')}}">
                    <img src="assets/img/logo.png" class="navbar-logo text-white" alt="logo">
                    <b style="font-size: 19px; color:#fff">SPV</b>
                </a>
            </li>
        </ul>
                        ...
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                ...
                                <div class="media-body">
                                    <h5>@guest Minino @else {{Auth()->user()->name}} @endguest</h5>
                                    <p>Developer</p>
                                </div>
                            </div>
                        </div>
